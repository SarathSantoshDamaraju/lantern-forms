 ...
 * @since 1.0.0
 *
 * @method awsmug\Lantern_Forms\DB_Objects\Forms\Form_Manager                         forms()
 * @method awsmug\Lantern_Forms\DB_Objects\Form_Categories\Form_Category_Manager      form_categories()
 * @method awsmug\Lantern_Forms\DB_Objects\Containers\Container_Manager               containers()
 * @method awsmug\Lantern_Forms\DB_Objects\Elements\Element_Manager                   elements()
 * @method awsmug\Lantern_Forms\DB_Objects\Element_Choices\Element_Choice_Manager     element_choices()
 * @method awsmug\Lantern_Forms\DB_Objects\Element_Settings\Element_Setting_Manager   element_settings()
 * @method awsmug\Lantern_Forms\DB_Objects\Submissions\Submission_Manager             submissions()
 * @method awsmug\Lantern_Forms\DB_Objects\Submission_Values\Submission_Value_Manager submission_values()
 * @method awsmug\Lantern_Forms\DB_Objects\Post_Type_Manager                          post_types()
 * @method awsmug\Lantern_Forms\DB_Objects\Taxonomy_Manager                           taxonomies()
 * @method awsmug\Lantern_Forms\Components\Form_Upload_Manager                        form_uploads()
 * @method awsmug\Lantern_Forms\Components\Template_Tag_Handler_Manager               template_tag_handlers()
 * @method Leaves_And_Love\Plugin_Lib\Components\Admin_Pages                        admin_pages()
 * @method awsmug\Lantern_Forms\Components\Extensions                                 extensions()
 * @method awsmug\Lantern_Forms\Modules\Module_Manager                                modules()
 * @method Leaves_And_Love\Plugin_Lib\Options                                       options()
 * @method Leaves_And_Love\Plugin_Lib\Cache                                         cache()
 * @method awsmug\Lantern_Forms\DB                                                    db()
 * @method Leaves_And_Love\Plugin_Lib\Meta                                          meta()
 * @method awsmug\Lantern_Forms\Assets                                                assets()
 * @method Leaves_And_Love\Plugin_Lib\Template                                      template()
 * @method Leaves_And_Love\Plugin_Lib\AJAX                                          ajax()
 * @method awsmug\Lantern_Forms\Error_Handler                                         error_handler()
 */
class Lantern_Forms extends Leaves_And_Love_Plugin {

	/**
	 * The forms manager instance.
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Forms\Form_Manager
	 */
	protected $forms;
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Form_Categories\Form_Category_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Containers\Container_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Elements\Element_Manager
	 */
	protected $elements;
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Element_Choices\Element_Choice_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Element_Settings\Element_Setting_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Submissions\Submission_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Submission_Values\Submission_Value_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Post_Type_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\DB_Objects\Taxonomy_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Components\Form_Upload_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Components\Template_Tag_Handler_Manager
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Components\Extensions
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Modules\Module_Manager
	 */
	protected $modules;
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Assets
	 */
	protected $assets;
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\Error_Handler
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @var awsmug\Lantern_Forms\APIAPI_Config
	 */
	...
	public static function deactivate( $network_wide = false ) {
		if ( $network_wide ) {
			...
			foreach ( $sites as $site ) {
				...
				lantern()->submissions()->clear_cron_task();
	...
	public static function uninstall() {
		lantern()->db()->uninstall();
	}

	/**
	 * Returns the current version of Lantern Forms.
	 *
	 * @since 1.0.0
	 *
	...
	protected function load_base_properties() {
		$this->version      = '1.0.4';
		$this->prefix       = 'lantern_';
		$this->vendor_name  = 'awsmug';
		$this->project_name = 'Lantern_Forms';
	...
	protected function load_textdomain() {
		...
		$locale = apply_filters( 'plugin_locale', get_locale(), 'lantern-forms' );

		$mofile = WP_LANG_DIR . '/plugins/lantern-forms/lantern-forms-' . $locale . '.mo';
		if ( file_exists( $mofile ) ) {
			return load_textdomain( 'lantern-forms', $mofile );
		}

		$this->load_plugin_textdomain( 'lantern-forms' );
	}
	...
	protected function load_messages() {
		$this->messages['cheatin_huh'] = __( 'Cheatin&#8217; huh?', 'lantern-forms' );

		/* translators: %s: PHP version number */
		$this->messages['outdated_php'] = __( 'Lantern Forms cannot be initialized because your setup uses a PHP version older than %s.', 'lantern-forms' );

		/* translators: %s: WordPress version number */
		$this->messages['outdated_wp'] = __( 'Lantern Forms cannot be initialized because your setup uses a WordPress version older than %s.', 'lantern-forms' );
	}
	...
	protected function instantiate_services() {
		if ( defined( 'WP_CLI' ) && WP_CLI ) {
			WP_CLI::add_command(
				...
				array(
					'shortdesc' => 'Manage Lantern Forms content.',
				)
			);
		}
	...
	protected function setup_admin_pages() {
		...
		$submissions_list_class_name = 'awsmug\Lantern_Forms\DB_Objects\Submissions\Submissions_List_Page';
		$submission_edit_class_name  = 'awsmug\Lantern_Forms\DB_Objects\Submissions\Submission_Edit_Page';
		...
		$form_settings_class_name = 'awsmug\Lantern_Forms\DB_Objects\Forms\Form_Settings_Page';
		$form_settings_page       = new $form_settings_class_name( $this->admin_pages->get_prefix() . 'form_settings', $this->admin_pages, $this->forms );

		$this->admin_pages->add( 'form_settings', $form_settings_page, 'edit.php?post_type=lantern_form', null, 'site' );
	}
