...
class Translations_Extensions extends Translations_Extensions_Base {
	...
	protected function init() {
		$this->translations = array(
			...
			'extension_class_not_exist'    => __( 'The extension class %s does not exist.', 'lantern-forms' ),
			/* translators: 1: class name, 2: other class name */
			'extension_class_invalid'      => __( 'The extension class %1$s is invalid, as it does not inherit the %2$s class.', 'lantern-forms' ),
			/* translators: %s: extension name */
			'extension_already_registered' => __( 'An extension with the name &#8220;%s&#8221; is already registered.', 'lantern-forms' ),
		);
	}
}
