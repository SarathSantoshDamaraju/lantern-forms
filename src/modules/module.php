...
use awsmug\Lantern_Forms\DB_Objects\Forms\Form_Edit_Page_Handler;
use awsmug\Lantern_Forms\DB_Objects\Forms\Form_Settings_Page;
	...
	final protected function add_settings( $settings_page ) {
		...
		$settings_page->add_tab(
			...
			array(
				...
				'rest_description' => sprintf( _x( 'Lantern Forms %s module settings.', 'REST API description', 'lantern-forms' ), $this->get_title() ),
			)
		);
