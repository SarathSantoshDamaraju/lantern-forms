...
class Submission_Count extends Access_Control {
	...
	protected function bootstrap() {
		...
		$this->title = __( 'Submission Count', 'lantern-forms' );
	}
	...
	public function get_meta_fields() {
		...
		$meta_fields['total_submissions_limit']           = array(
			'type'         => 'number',
			'label'        => __( 'Total Submissions Limit', 'lantern-forms' ),
			'description'  => __( 'Enter the total amount of submissions that are allowed to be submitted for this form.', 'lantern-forms' ),
			'min'          => 0,
			'step'         => 1,
			'default'      => 100,
		...
		$meta_fields['total_submissions_reached_message'] = array(
			'type'          => 'text',
			'label'         => __( '&#8220;Total submissions reached&#8221; Message', 'lantern-forms' ),
			'description'   => __( 'Enter the message to show to the user when a sufficient amount of submissions have already been completed.', 'lantern-forms' ),
	...
	protected function get_default_total_submissions_reached_message() {
		return __( 'This form is no longer open to submissions since the maximum number of submissions has been reached.', 'lantern-forms' );
	}
}
