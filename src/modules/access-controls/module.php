...
class Module extends Module_Base implements Submodule_Registry_Interface {
	...
	protected function bootstrap() {
		...
		$this->title       = __( 'Access Controls', 'lantern-forms' );
		$this->description = __( 'Access controls allow to limit who has permissions to view and submit a form.', 'lantern-forms' );
