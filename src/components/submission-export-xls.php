...
class Submission_Export_XLS extends Submission_Export {
	...
	protected function bootstrap() {
		$this->slug          = 'xls';
		$this->title         = _x( 'XLS', 'file extension', 'lantern-forms' );
		$this->description   = __( 'Exports submissions in XLS format, to be used by table processing software such as Excel.', 'lantern-forms' );
