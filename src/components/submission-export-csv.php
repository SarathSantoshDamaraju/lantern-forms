...
class Submission_Export_CSV extends Submission_Export {
	...
	protected function bootstrap() {
		$this->slug          = 'csv';
		$this->title         = _x( 'CSV', 'file extension', 'lantern-forms' );
		$this->description   = __( 'Exports submissions in CSV format, raw data to be used for importing into other software.', 'lantern-forms' );
