...
namespace awsmug\Lantern_Forms;
...
class Assets extends Assets_Base {
	...
	public function render_icon( $icon_id, $title = '', $class = '' ) {
		...
		?>
		<svg class="lantern-icon <?php echo esc_attr( $class ); ?>"<?php echo $aria_hidden . $aria_labelledby; // WPCS: XSS OK. ?> role="img">
			<?php if ( ! empty( $title ) ) : ?>
	...
	protected function register_assets() {
		...
		$this->register_script(
			...
			array(
				...
				'ver'           => $this->plugin_version,
				'in_footer'     => true,
				'localize_name' => 'lanternBuilderI18n',
				'localize_data' => array(
					'couldNotInitCanvas'         => __( 'Could not initialize form canvas as the selector points to an element that does not exist.', 'lantern-forms' ),
					'couldNotLoadData'           => __( 'Could not load form builder data. Please verify that the REST API is correctly enabled on your site.', 'lantern-forms' ),
					/* translators: %s: container index number */
					'defaultContainerLabel'      => __( 'Page %s', 'lantern-forms' ),
					/* translators: %s: element choice index number */
					'elementChoiceLabel'         => __( 'Choice %s', 'lantern-forms' ),
					'showContent'                => __( 'Show Content', 'lantern-forms' ),
					'hideContent'                => __( 'Hide Content', 'lantern-forms' ),
					'yes'                        => __( 'Yes', 'lantern-forms' ),
					'no'                         => __( 'No', 'lantern-forms' ),
					'confirmDeleteContainer'     => __( 'Do you really want to delete this page?', 'lantern-forms' ),
					'confirmDeleteElement'       => __( 'Do you really want to delete this element?', 'lantern-forms' ),
					'confirmDeleteElementChoice' => __( 'Do you really want to delete this choice?', 'lantern-forms' ),
					'selectElementType'          => __( 'Select Element Type', 'lantern-forms' ),
					'insertIntoContainer'        => __( 'Insert into container', 'lantern-forms' ),
				),
			)
		);
