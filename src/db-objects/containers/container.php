...
use awsmug\Lantern_Forms\DB_Objects\Elements\Element_Collection;
use WP_Error;
...
class Container extends Model {
	 ...
	 * @return awsmug\Lantern_Forms\DB_Objects\Elements\Element_Collection List of elements.
	 */
	...
	public function to_json( $include_meta = true ) {
		...
		$required_indicator_description = '<span aria-hidden="true">' . sprintf( __( 'Required fields are marked %s.', 'lantern-forms' ), '<span class="lantern-required-indicator">*</span>' ) . '</span>';
