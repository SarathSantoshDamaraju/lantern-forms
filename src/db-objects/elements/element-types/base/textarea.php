...
class Textarea extends Element_Type {
	...
	protected function bootstrap() {
		$this->slug        = 'textarea';
		$this->title       = __( 'Textarea', 'lantern-forms' );
		$this->description = __( 'A textarea element.', 'lantern-forms' );
		$this->icon_svg_id = 'lantern-icon-textarea';
		...
		$this->settings_fields['rows']       = array(
			'section'       => 'settings',
			'type'          => 'number',
			'label'         => __( 'Rows', 'lantern-forms' ),
			'description'   => __( 'Number of rows for typing in  (can be overwritten by CSS).', 'lantern-forms' ),
			'input_classes' => array( 'small-text' ),
			'default'       => 10,
			'min'           => 0,
			'step'          => 1,
		...
		$this->settings_fields['cols']       = array(
			'section'       => 'settings',
			'type'          => 'number',
			'label'         => __( 'Columns', 'lantern-forms' ),
			'description'   => __( 'Number of columns for typing in (can be overwritten by CSS).', 'lantern-forms' ),
			'input_classes' => array( 'small-text' ),
			'default'       => 75,
			'min'           => 0,
			'step'          => 1,
