...
namespace awsmug\Lantern_Forms\DB_Objects\Elements;
...
use awsmug\Lantern_Forms\DB_Objects\Element_Choices\Element_Choice_Collection;
use awsmug\Lantern_Forms\DB_Objects\Element_Settings\Element_Setting_Collection;
use awsmug\Lantern_Forms\DB_Objects\Elements\Element_Types\Element_Type;
use awsmug\Lantern_Forms\DB_Objects\Elements\Element_Types\Non_Input_Element_Type_Interface;
use awsmug\Lantern_Forms\DB_Objects\Elements\Element_Types\Choice_Element_Type_Interface;
use awsmug\Lantern_Forms\DB_Objects\Elements\Element_Types\Multi_Field_Element_Type_Interface;
...
class Element extends Model {
	...
	public function to_json( $include_meta = true, $submission = null ) {
		 ...
		 */
		$input_classes = apply_filters( "{$this->manager->get_prefix()}element_input_classes", array( 'lantern-element-input' ), $this );
		 ...
		 * @param Element $element       Element object.
		 */
		$label_classes = apply_filters( "{$this->manager->get_prefix()}element_label_classes", array( 'lantern-element-label' ), $this );
		 ...
		 * @param Element $element      Element object.
		 */
		$wrap_classes = apply_filters( "{$this->manager->get_prefix()}element_wrap_classes", array( 'lantern-element-wrap' ), $this );
		 ...
		 * @param Element $element             Element object.
		 */
		$description_classes = apply_filters( "{$this->manager->get_prefix()}element_description_classes", array( 'lantern-element-description' ), $this );
		 ...
		 * @param Element $element        Element object.
		 */
		$errors_classes = apply_filters( "{$this->manager->get_prefix()}element_errors_classes", array( 'lantern-element-errors' ), $this );
		...
		$data = array_merge(
			...
			array(
				'value'             => null,
				'input_attrs'       => array(
					'id'    => 'lantern-element-' . $this->id,
					'name'  => 'lantern_submission[values][' . $this->id . '][_main]',
					'class' => implode( ' ', $input_classes ),
				),
				'label_required'    => '',
				'label_attrs'       => array(
					'id'    => 'lantern-element-' . $this->id . '-label',
					'class' => implode( ' ', $label_classes ),
					'for'   => 'lantern-element-' . $this->id,
				),
				'wrap_attrs'        => array(
					'id'    => 'lantern-element-' . $this->id . '-wrap',
					'class' => implode( ' ', $wrap_classes ),
				),
				'description'       => '',
				'description_attrs' => array(
					'id'    => 'lantern-element-' . $this->id . '-description',
					'class' => implode( ' ', $description_classes ),
				),
				'errors'            => array(),
				'errors_attrs'      => array(
					'id'    => 'lantern-element-' . $this->id . '-errors',
