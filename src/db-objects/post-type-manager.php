...
class Post_Type_Manager extends Post_Type_Manager_Base {
	...
	protected function register_form_post_type() {
		...
		$rewrite_slug = ! empty( $options['slug'] ) ? $options['slug'] : _x( 'forms', 'default form rewrite slug', 'lantern-forms' );
		...
		$args = array(
			'labels'              => array(
				'name'                  => __( 'Forms', 'lantern-forms' ),
				'singular_name'         => __( 'Form', 'lantern-forms' ),
				'add_new'               => _x( 'Add New', 'form label', 'lantern-forms' ),
				'add_new_item'          => __( 'Add New Form', 'lantern-forms' ),
				'edit_item'             => __( 'Edit Form', 'lantern-forms' ),
				'new_item'              => __( 'New Form', 'lantern-forms' ),
				'view_item'             => __( 'View Form', 'lantern-forms' ),
				'view_items'            => __( 'View Forms', 'lantern-forms' ),
				'search_items'          => __( 'Search Forms', 'lantern-forms' ),
				'not_found'             => __( 'No forms found.', 'lantern-forms' ),
				'not_found_in_trash'    => __( 'No forms found in Trash.', 'lantern-forms' ),
				'parent_item_colon'     => __( 'Parent Form:', 'lantern-forms' ),
				'all_items'             => __( 'All Forms', 'lantern-forms' ),
				'archives'              => __( 'Form Archives', 'lantern-forms' ),
				'attributes'            => __( 'Form Attributes', 'lantern-forms' ),
				'insert_into_item'      => __( 'Insert into form', 'lantern-forms' ),
				'uploaded_to_this_item' => __( 'Uploaded to this form', 'lantern-forms' ),
				'filter_items_list'     => __( 'Filter forms list', 'lantern-forms' ),
				'items_list_navigation' => __( 'Forms list navigation', 'lantern-forms' ),
				'items_list'            => __( 'Forms list', 'lantern-forms' ),
				'menu_name'             => __( 'Forms', 'lantern-forms' ),
			),
			'public'              => true,
			'hierarchical'        => false,
