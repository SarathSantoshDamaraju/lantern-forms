...
namespace awsmug\Lantern_Forms\DB_Objects;
...
class Taxonomy_Manager extends Taxonomy_Manager_Base {
	...
	protected function register_form_category_taxonomy() {
		$rewrite_slug = _x( 'form-categories', 'default form category rewrite slug', 'lantern-forms' );

		$args = array(
			'labels'            => array(
				'name'                       => __( 'Categories', 'lantern-forms' ),
				'singular_name'              => __( 'Category', 'lantern-forms' ),
				'search_items'               => __( 'Search Categories', 'lantern-forms' ),
				'popular_items'              => __( 'Popular Categories', 'lantern-forms' ),
				'all_items'                  => __( 'All Categories', 'lantern-forms' ),
				'parent_item'                => __( 'Parent Category', 'lantern-forms' ),
				'parent_item_colon'          => __( 'Parent Category:', 'lantern-forms' ),
				'edit_item'                  => __( 'Edit Category', 'lantern-forms' ),
				'view_item'                  => __( 'View Category', 'lantern-forms' ),
				'update_item'                => __( 'Update Category', 'lantern-forms' ),
				'add_new_item'               => __( 'Add New Category', 'lantern-forms' ),
				'new_item_name'              => __( 'New Category Name', 'lantern-forms' ),
				'separate_items_with_commas' => __( 'Separate categories with commas', 'lantern-forms' ),
				'add_or_remove_items'        => __( 'Add or remove categories', 'lantern-forms' ),
				'choose_from_most_used'      => __( 'Choose from the most used categories', 'lantern-forms' ),
				'not_found'                  => __( 'No categories found.', 'lantern-forms' ),
				'no_terms'                   => __( 'No categories', 'lantern-forms' ),
				'items_list_navigation'      => __( 'Categories list navigation', 'lantern-forms' ),
				'items_list'                 => __( 'Categories list', 'lantern-forms' ),
				'menu_name'                  => __( 'Categories', 'lantern-forms' ),
			),
			'public'            => false,
			'show_ui'           => true,
			'hierarchical'      => true,
	...
	protected function create_default_attachment_taxonomy_term() {
		...
		$result = wp_insert_term( __( 'Form Upload', 'lantern-forms' ), $taxonomy_slug );
