...
class Submissions_List_Table extends Models_List_Table {
	...
	public function column_status( $submission ) {
		if ( 'completed' === $submission->status ) {
			echo '<strong>' . esc_html_x( 'Completed', 'submission status label', 'lantern-forms' ) . '</strong>';
		} elseif ( 'progressing' === $submission->status ) {
			echo esc_html_x( 'In Progress', 'submission status label', 'lantern-forms' );
		}
	}
	...
	protected function build_columns() {
		...
		$columns['id']        = _x( 'ID', 'submission column label', 'lantern-forms' );
		$columns['status']    = _x( 'Status', 'submission column label', 'lantern-forms' );
		$columns['form_id']   = _x( 'Form', 'submission column label', 'lantern-forms' );
		$columns['user_id']   = _x( 'User', 'submission column label', 'lantern-forms' );
		$columns['timestamp'] = _x( 'Date', 'submission column label', 'lantern-forms' );
