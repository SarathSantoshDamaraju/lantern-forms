...
use awsmug\Lantern_Forms\DB_Objects\Manager_With_Parents_Trait;
use awsmug\Lantern_Forms\DB_Objects\Manager_With_Children_Trait;
use awsmug\Lantern_Forms\Translations\Translations_Submission_Manager;
use awsmug\Lantern_Forms\DB;
use awsmug\Lantern_Forms\Components\Submission_Export_Handler;
...
class Submission_Manager extends Manager {
	...
	public function set_initial_submission_data( $submission, $form ) {
		...
		if ( filter_has_var( INPUT_COOKIE, 'lantern_identity' ) ) {
			$submission->user_key = esc_attr( filter_input( INPUT_COOKIE, 'lantern_identity' ) );
		} elseif ( isset( $_SESSION ) && ! empty( $_SESSION['lantern_identity'] ) ) {
			$submission->user_key = esc_attr( wp_unslash( $_SESSION['lantern_identity'] ) );
		} else {
		...
		$_SESSION['lantern_identity'] = $submission->user_key;
	}
	...
	public function render_status_select( $id, $submission ) {
		...
		<div class="misc-pub-section">
			<div id="date-information">
				<?php esc_html_e( 'Date:', 'lantern-forms' ); ?>
		...
		<div class="misc-pub-section">
			<div id="post-status-select">
				...
				<select id="post-status" name="status">
					<option value="completed"<?php selected( $current_status, 'completed' ); ?>><?php echo esc_html_x( 'Completed', 'submission status label', 'lantern-forms' ); ?></option>
					<option value="progressing"<?php selected( $current_status, 'progressing' ); ?>><?php echo esc_html_x( 'In Progress', 'submission status label', 'lantern-forms' ); ?></option>
				</select>
			</div>
		</div>
		<?php
