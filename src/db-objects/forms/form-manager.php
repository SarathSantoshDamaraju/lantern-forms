...
use awsmug\Lantern_Forms\Translations\Translations_Form_Manager;
use awsmug\Lantern_Forms\Assets;
use awsmug\Lantern_Forms\DB;
use awsmug\Lantern_Forms\Components\Legacy_Upgrades;
...
class Form_Manager extends Core_Manager {
	...
	protected function register_settings() {
		$settings_page = new Form_Settings_Page( 'form_settings', lantern()->admin_pages(), $this );
	...
	protected function maybe_start_session() {
		...
		if ( filter_input( INPUT_POST, 'lantern_submission' ) ) {
			session_start();
			return;
		}
