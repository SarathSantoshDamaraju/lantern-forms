...
namespace awsmug\Lantern_Forms\DB_Objects\Form_Categories;
...
class REST_Form_Categories_Controller extends REST_Models_Controller {
	...
	public function get_item_schema() {
		...
		$schema['properties']['description'] = array(
			'description' => __( 'Description for the form category.', 'lantern-forms' ),
			'type'        => 'string',
			'context'     => array( 'view', 'edit', 'embed' ),
		);

		$schema['properties']['parent'] = array(
			'description' => __( 'ID of the parent of the form category, if any.', 'lantern-forms' ),
			'type'        => 'integer',
			'context'     => array( 'view', 'edit', 'embed' ),
			'arg_options' => array(
				'minimum' => 0,
		...
		$schema['properties']['count'] = array(
			'description' => __( 'Number of forms associated with the form category.', 'lantern-forms' ),
			'type'        => 'integer',
			'context'     => array( 'view', 'edit', 'embed' ),
			'readonly'    => true,
		);
