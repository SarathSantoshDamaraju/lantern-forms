...
<div<?php echo lantern()->template()->attrs( $wrap_attrs ); ?>>
	...
	<div>
		...
		<input type="file"<?php echo lantern()->template()->attrs( $input_attrs ); ?>>

		<input type="hidden" name="<?php echo lantern()->template()->esc_attr( $hidden_name ); ?>" value="<?php echo lantern()->template()->esc_attr( $value ); ?>">
