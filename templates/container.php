...
?>
<?php if ( ! empty( $label ) ) : ?>
	<h2 class="lantern-container-title"><?php echo lantern()->template()->esc_kses_basic( $label ); ?></h2>
<?php endif; ?>

<?php if ( ! empty( $required_description ) ) : ?>
	<p><?php echo lantern()->template()->esc_kses_basic( $required_description ); ?></p>
<?php endif; ?>
...
<?php foreach ( $elements as $element ) : ?>
	<?php lantern()->template()->get_partial( 'element', $element ); ?>
<?php endforeach; ?>
