...
?>
<fieldset<?php echo lantern()->template()->attrs( $wrap_attrs ); ?>>
	<?php if ( ! empty( $before ) ) : ?>
		<?php echo $before; ?>
	<?php endif; ?>

	<legend<?php echo lantern()->template()->attrs( $legend_attrs ); ?>>
	...
	<div>
		...
		<?php foreach ( $choices as $index => $choice ) : ?>
			...
			?>
			<div class="lantern-toggle">
				<input type="checkbox"<?php echo lantern()->template()->attrs( $choice_input_attrs ); ?> value="<?php echo lantern()->template()->esc_attr( $choice ); ?>"<?php echo in_array( $choice, $value, true ) ? ' checked' : ''; ?>>
				<label<?php echo lantern()->template()->attrs( $choice_label_attrs ); ?>>
					<?php echo lantern()->template()->esc_kses_basic( $choice ); ?>
				</label>
			</div>
		<?php endforeach; ?>
