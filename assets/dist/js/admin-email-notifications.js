 ...
 */
( function( lantern, fieldsAPI, $, data ) {
	'use strict';

	var builder       = lantern.Builder.getInstance();
	var elementModels = {};
	...
	$( document ).ready( function() {
		var fieldManagerInstanceId = $( '#lantern_module_actions-field-manager-instance' );
...
}( window.lantern, window.pluginLibFieldsAPI, window.jQuery, window.lanternEmailNotifications ) );
